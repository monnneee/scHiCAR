...
def update_fastq(r1,r2,out_r1,out_r2, barcode_dic,white_list_barcode,log_file): ## process one files
    ...
    while True:
        ...
        cur_barcode = (cur_r1_name[0:18])  ## makesure the barcode length
        ...
        if  cur_barcode in barcode_dic or cur_barcode in white_list_barcode : ## only the whitelist or corrected barcode are remained
            ...
            cur_r1_name = (cur_barcode + cur_r1_name[18:]) ## 18bp cell barcode
            #cur_r1_read = (cur_barcode + cur_r1_read[18:]) ## 18bp cell barcode
            cur_r2_name = (cur_barcode + cur_r2_name[18:]) 
...
white_list_barcode = from_file_to_barcode_list('scHiCAR_DNA_18bp_barcode.txt.gz')
